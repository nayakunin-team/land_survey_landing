  ...
  return (
    <section className="flex flex-row pt-20 pb-8 bg-primary-main">
      <div className="flex flex-col">
        ...
        <Link href="#contacts" passHref><button className="w-60 h-16 ml-40 mt-10 bg-secondary-green rounded"><span className="text-2xl text-primary-light">Связаться с нами</span></button></Link>
      </div>
      <div className="w-1/2 h-1/2 mr-20"><Image src={geo} alt="Geo"/></div>
    </section>
  );
}
