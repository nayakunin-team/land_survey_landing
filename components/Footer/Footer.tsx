  ...
  return (
    <section className="py-10 flex bg-third-main">
      <div className="w-1/3 ml-20 flex items-center">
        ...
        <p className="ml-6 text-3xl text-primary-dark">Центральное<br />Агенство<br />Землеустройства</p>
      </div>
      ...
      <div className="w-1/4 ml-10">
        <p className="text-primary-dark">ул. Связи, д. 11, офис 1<br />ул. Татарская, д. 21 БЦ Флагман, офис 104<br />+7(tttt) tt-tt-tt,  caz_rzn@mail.ru</p>
        {/* <Image /> */}
        {/* <Image /> */}
        {/* <Image /> */}
      </div>
